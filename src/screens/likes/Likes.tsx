...
const Likes = (props) => {
  ...
  const renderRightActions = (progress, dragX) => {
    ...
    return (
      <View style={styles.swipeRightContainer}>
        <Animated.View style={[styles.swipeText, { transform: [{ scale }] }]}>
          <View style={styles.swipeIconContainer}>
            <Entypo name="cross" size={80} color={AppColors.appThemeColor} />
          </View>
        </Animated.View>
      </View>
    );
  ...
  const renderLeftActions = (progress, dragX) => {
    ...
    return (
      <View style={styles.swipeRightContainer}>
        <Animated.View style={[styles.swipeText, { transform: [{ scale }] }]}>
          <View style={styles.swipeIconContainerHeart}>
            <Entypo name="heart" size={55} color={AppColors.appThemeColor} />
          </View>
        </Animated.View>
      </View>
    );
  ...
  const renderLikedUser = ({ item }) => {
    ...
    return (
      <Swipeable
        ...
        onSwipeableLeftOpen={() => {
          handleSwipeLeft(item?._id);
        }}
        onSwipeableRightOpen={() => {
          handleSwipeRight(item?._id);
        }}
      >
        <TouchableOpacity
  ...
  let profileData1 = [
    {
      _id: "67db252cde2ebcb65638e17f",
      age: 26,
      ethnicity: "Afghan",
      fullName: "Arslan Sender Is Here",
      justJoined: true,
      location: "Afghanistan",
      photo: "data:image/png;base64,undefined",
      profession: "Acting Professional",
      timeOfLike: "21 hours",
    },
    {
      _id: "67db252cde2ebcb65638e17f",
        ...
        {count === 0 ? (
          ...
          >
            ...
            <CommonButton
              ...
              pressHandler={() =>
                props.navigation.navigate("Boosting", { back: 13 })
              }
            />
          </View>
        ) : (
